...
const Book = () => {
  ...
  const getSeatData = (wingn, daten, shiftn) => {
    ...
    setIsLoading(true);
    axios.post("https://reactbackapi.onrender.com/availablity", datas).then((response) => {
  ...
  const getWings = () => {
    ...
    axios.get("https://reactbackapi.onrender.com/availablity/wings").then((response) => {
      if (response.status == 200) {
  ...
  const getShifts = () => {
    ...
    axios.get("https://reactbackapi.onrender.com/availablity/shifts").then((response) => {
      if (response.status == 200) {
  ...
  const bookSeat = () => {
    ...
    axios.post("https://reactbackapi.onrender.com/booking", bookData).then((response) => {
